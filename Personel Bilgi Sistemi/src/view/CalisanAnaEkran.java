...
public class CalisanAnaEkran extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CalisanAnaEkran frame = new CalisanAnaEkran();
	...
	public CalisanAnaEkran() {
		...
		btnKaydet.setBounds(264, 373, 128, 29);
		...
		btnNewButton.setBounds(485, 373, 115, 29);
