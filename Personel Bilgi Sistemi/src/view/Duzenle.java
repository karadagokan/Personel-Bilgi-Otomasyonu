...
public class Duzenle extends JFrame {
	...
	static JComboBox comboBoxCinsiyet;
	static JComboBox comboBoxOgrenimDurumu;
	...
	public Duzenle() {
		...
		comboBoxCinsiyet = new JComboBox();
		...
		comboBoxOgrenimDurumu = new JComboBox();
		...
		btnKaydet.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
		    	...
		    	VeriTabani.vtKisiGuncelle(textFieldKimlikNo.getText(), textFieldAd.getText(), textFieldSoyad.getText(), cinsiyetYaz, editorPaneAdres.getText(), textFieldDogumYeri.getText(), textFieldDogumTarihi.getText(), textFieldTelefon.getText(), null, ogrenimDurumu, textFieldEnSonCalistigi.getText(), null, textFieldDepartman.getText(), textFieldCalistigiPozisyon.getText(), "ab", textFieldHastaliklar.getText(), false, textFieldSifre.getText());
